...
s1.item4.initialize_item_button();
s1.item5.initialize_item_button();
...
s3.item3.initialize_item_button();
s3.item4.initialize_item_button();
s3.item5.initialize_item_button();
s3.item6.initialize_item_button();
s3.item7.initialize_item_button();
s3.item8.initialize_item_button();
s3.item9.initialize_item_button();
s3.item10.initialize_item_button();

// Fruits and Vegs - Section 4
...
// ABOVE s1.reset.initialize_reset_button();
